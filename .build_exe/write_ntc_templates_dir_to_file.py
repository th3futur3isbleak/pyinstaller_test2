...
def main():
    ...
    for site_package_directory in site_packages_directories:
        ...
        if 'site-packages' in site_package_directory:
            ...
            file_path = os.path.join(os.path.dirname(__file__), 'ntc_templates_dir.txt')
            with open(file_path, 'w') as output_file:
               output_file.write(f"{os.path.normpath(ntc_templates_dir)}\n")
            # os.environ['NTC_TEMPLATES_DIR'] = os.path.normpath(ntc_templates_dir)
